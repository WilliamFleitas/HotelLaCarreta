...
export const RoomCarrusel = () => {
  ...
  <div className="overflow-x-hidden">
    ...
    <div className="text-[#696969] justify-center items-center text-center p-5 py-5 leading-[25px]	">
      ...
      <p className="text-[25px] ">Las habitaciones de la posada cuentan con todo lo que necesitas para relajarte de la forma más placentera durante su estadía en el campo, actualmente contamos con una zona de habitaciones rustica y otra moderna. ¡Elija la que más le guste!</p>
      </div>
