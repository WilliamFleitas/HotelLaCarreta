    ...
    return (
        <div className="text-[#696969] pt-6 text-center justify-center items-center  p-5 overflow-clip tsw:p-14 md:mt-20 aser:pt-36" data-aos-duration="900" data-aos-easing="ease-in-out" data-aos='zoom-in'>
            ...
            <div className=" p-5 md:grid md:grid-cols-2 md:p-8 h-full w-full md:space-x-5">
                ...
                <p className="text-center pt-8 md:pt-[15%] md:leading-[30px] text-[18px] md:text-[24px] aser:text-[28px] lg:text-[34px] lg:pt-[20%] ggg:text-[38px] ggg:leading-[40px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, deserunt minus hic voluptate soluta praesentium laborum harum voluptas dolorem amet possimus sapiente dolores! Officia voluptates dolores, tempore cum quidem incidunt.</p>
            </div>

            <div className="pt-10 p-5" >
                <h2 className="text-[23px] text-[#E2725B] pb-8 md:text-[26px] aser:text-[35px] lg:text-[40px]  ggg:text-[48px] ">Vista Aerea</h2>
            ...
            <h2 data-aos-duration="900" data-aos-easing="ease-in-out" data-aos='zoom-in'>Nuestra misión</h2>
            <div className="text-[15px] pt-5 space-y-5 md:grid md:grid-cols-3 md:space-y-0 " data-aos-duration="900" data-aos-easing="ease-in-out" data-aos='zoom-in'>
         ...
         <section id="facilitiesDiv"></section>
            ...
            <h2 className="text-[23px] text-start text-[#E2725B] pt-14 pl-5 hover:opacity-[70%] mb-14 md:text-[40px]" > {"> Instalaciones"}</h2> 
                  ...
                  width < 768 ?  facilitiesDiv ? facilities.length ? facilities.map((e, index) => {
                        return (
                            <div className="border-b-4 w-screen p-5 grid grid-cols-2 md:grid-cols-1 items-center justify-center space-x-5 md:w-full md:flex md:flex-col-reverse" key={e.id}>
                                ...
                                <div className="">
                                <h2 className=" text-[#E2725B]  text-[23px] pb-3 md:order-last">{e.name}</h2>
        ...
        <div className="mb-10 mt-14 p-5  md:p-8 h-full w-full  border-t-4 pt-14 border-black bg-zinc-800 shadow-md  shadow-black text-white pb-14">
                 ...
                 <h2 className="text-[30px] text-[#E2725B] md:text-[26px] aser:text-[35px] lg:text-[40px]  ggg:text-[48px] ">Proyecto intercambio</h2>
        ...
        <div className=" p-5 md:p-8 h-full w-full  pt-14 border-t-4 border-black bg-zinc-800 shadow-md  shadow-black text-white pb-14">
                 ...
                 <h2 className="text-[30px] text-[#E2725B] md:text-[26px] aser:text-[35px] lg:text-[40px]  ggg:text-[48px] ">Proyecto rural</h2>
                 <div className="md:grid md:grid-cols-2 md:p-5 md:space-x-5 ">
