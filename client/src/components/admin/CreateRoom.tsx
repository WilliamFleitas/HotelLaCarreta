...
export const CreateRoom = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row gap-5 text-center items-center justify-center m-auto">
      <div className="text-end">
        <NavLink to="/admin/dashboard">
        <button
          className="border-2 border-red-300 z-50 mt-14 p-1 text-[#E2725B]  rounded-lg shadow-md shadow-red-300 "
        >
          Panel admin
        </button>
        </NavLink>
      ...
      <form
        className="pt-[40px] text-black p-4 mt-14 flex flex-col w-[405px] h-full justify-center items-center align-center text-center border-2 shadow-lg shadow-black"
        onSubmit={onSubmit}
      >
        ...
        <div className=" text-black flex flex-col w-full ">
          ...
          <input
            className={`w-full border border-[#B35642] rounded-xl px-3 py-2`}
            type="text"
            id="name"
            {...register("name")}
          />
          ...
          <label className="text-sm text-black border-2 border-black relative top-[8px] left-3 bg-[#B35642] w-fit px-1 rounded-xl">
            Descripción
          </label>
          <textarea
            id="description"
            className="w-full border border-[#B35642] rounded-xl px-3 py-2 p-2 text-black h-full text-start"
          ...
          <label className="text-sm text-black relative top-[8px] left-3 bg-[#B35642] w-fit border-2 border-black px-1 rounded-xl">
            Mini Descripción
          </label>
          <input
            className="w-full border border-[#B35642]  rounded-xl px-3 py-2 h-18"
            type="text"
            id="preDescription"
          ...
          <label className="text-sm text-black relative top-[8px] left-3 bg-[#B35642] w-fit px-1 rounded-xl border-2 border-black">
            Imagenes
          </label>
                ...
                {images?.map((e: any, index: any) => {
                  return (
                    <div className="pt-3 h-28 " key={index}>
                      ...
                      <button
                        type="button"
                        onClick={() => handleDeleteImg(e, index)}
                      >
                        {<MdDelete />}
                      </button>
                    </div>
          ...
          <select
            className="w-full border mb-10 border-[#B35642] rounded-xl px-3 py-2"
          ...
          <div className="">
            <input
              className="w-[200px] border border-[#B35642] rounded-xl px-3 py-2"
            ...
            />
            <button
              className=" text-sm p-2 text-white  border-black bg-[#B35642] rounded-xl"
              id="buttoRoomFeat"
              type="button"
              name="buttonRoomFeat"
              onClick={() =>
          ...
          <div>
            <input
              ...
              value={featureInput.bathroom_features}
              {...register("bathroom_features")}
              onChange={(e) => handleInput(e)}
            />
            <button
              className=" text-sm p-2 text-white border bg-[#B35642] rounded-xl"
              id="buttobathRoomFeat"
              type="button"
              name="buttobathRoomFeat"
              onClick={() =>
                addNewFeature(
                  featureInput.bathroom_features,
                  "bathroom_features"
                )
              }
            >
                ...
                newBathroomFeature.map((e) => {
                  return (
                    <button
                      ...
                      key={e}
                      onClick={() =>
                        handleDeleteFeature(e, "bathroom_features")
                      }
                    >
                      <p>{e}</p>
                    </button>
