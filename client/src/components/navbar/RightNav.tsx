...
const RightNav = () => {
  ...
  return (
    ...
    <Menu right width={"85%"}>
      ...
      <NavLink to="/habitaciones" className="pl-4 py-4 ">
        Habitaciones
      </NavLink>
      <NavLink to="/sobreNosotros" className="pl-4 py-4">
        Sobre Nosotros
      </NavLink>
      <NavLink to="/condiciones" className="pl-4 py-4 ">
        Condiciones
      </NavLink>
      <NavLink to="/contacto" className="pl-4 py-4">
        Contacto
      </NavLink>
    </Menu>
  );
